...
export const jti_iconsData = [
  {
    id: 0,
    src: icon1,
    title: "Hva er JTI?",
    description:
      "JTI er forkortelse for Jungiansk Type Index og måler preferanser, våre forskjeller og våre styrker. Se vår introduksjonsfilm her.",
    shortListItems: [],
    listItems: [
  ...
  },
  {
    id: 1,
    src: icon2,
    title: "Hva kan JTI gjøre for deg?",
    description:
      "Lær om styrkene til dine kollegaer og få mest utnytte av personen.",
    shortListItems: [],
    listItems: [
