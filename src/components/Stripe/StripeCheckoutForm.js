...
const StripeCheckoutForm = () => {
  ...
  return (
    <div className="stripe-form-container">
      ...
      >
        <h2 className="text-white mb-6 uppercase font-600">
        ...
        {checkoutError ? (
          <div className="text-sm my-4 text-white">{checkoutError}</div>
        ) : null}
        <button
          className="bg-pink-400 hover:bg-pink-300 text-white font-bold py-2 px-4"
